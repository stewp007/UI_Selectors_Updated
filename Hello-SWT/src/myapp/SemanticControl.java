...
public abstract class SemanticControl {
    ...
    /**
     * Remove a value to the current list of values
     * 
     * @param value a value to be removed to the current Values
     */
    @SuppressWarnings("unchecked")
    public void removeCurrValue(Object value) {
        this.getCurrValue().remove(value);
    }
